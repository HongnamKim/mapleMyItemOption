...
public interface ClassMainStat {
    List<String> STR_CLASS = new ArrayList<>(List.of("히어로", "팔라딘", "다크나이트", "소울마스터", "미하일", "블래스터", "데몬슬레이어", "아란", "카이저", "아델", "제로", "바이퍼", "캐논슈터", "스트라이커", "은월", "아크"));
    List<String> DEX_CLASS = new ArrayList<>(List.of("보우마스터", "신궁", "패스파인더", "윈드브레이커", "와일드헌터", "메르세데스", "카인", "캡틴", "메카닉", "엔젤릭버스터"));
    List<String> LUK_CLASS = new ArrayList<>(List.of("나이트로드", "섀도어", "듀얼블레이더", "나이트워커", "팬텀", "카데나", "칼리", "호영"));
    ...
    List<String> TWO_SUB_STAT_CLASS = new ArrayList<>(List.of("듀얼블레이더", "섀도어", "카데나"));
