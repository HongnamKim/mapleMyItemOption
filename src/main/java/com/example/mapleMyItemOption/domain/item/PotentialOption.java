...
public interface PotentialOption {
    ...
    List<String> AVERAGE_LIST_SHORTEN = new ArrayList<>(List.of(TOTAL_STAT_PERCENT, "렙당", ATTACK_POWER, MAGIC_POWER));
    ...
    List<String> TOTAL_LIST_SHORTEN = new ArrayList<>(List.of("쿨감", ATTACK_POWER_PERCENT, MAGIC_POWER_PERCENT, "크뎀", "보공%", NORMAL_DAMAGE_PERCENT, "방무%", "드랍%", "메획%"));

    List<String> SHORT_OPTION = new ArrayList<>(List.of(PER_LEVEL, BOSS_DAMAGE, IGNORE_ARMOR, CRITICAL_DAMAGE, ITEM_DROP, MONEY_DROP, SKILL_COOL_TIME));
}
